...
export default function SchoolMarket() {
  ...
  const bjStart = () => {
    ...
    if (bet<10) return showToast("Mise minimum : 10 SC","err");
    if (bet>50) return showToast("Mise maximum : 50 SC","err");
          ...
          {casinoTab==="blackjack" && (<>
            {bjPhase==="bet" && (
              <div style={{background:"#f0f0f0",border:"1px solid #2a2a2a",borderRadius:12,padding:32,textAlign:"center"}}>
                ...
                <input type="number" value={bjBet} min={10} max={50} onChange={e=>setBjBet(Math.min(50,Math.max(10,parseInt(e.target.value)||10)))}
            ...
            <div>
              ...
              <div style={{background:"#f0f0f0",border:"1px solid #2a2a2a",borderRadius:12,padding:32,textAlign:"center"}}>
                ...
                <div style={{marginBottom:16}}>
                  ...
                  <input type="number" value={slotBet} min={10} max={50} onChange={e=>setSlotBet(Math.min(50,Math.max(10,parseInt(e.target.value)||10))}
                    style={{background:"#111111",border:"1px solid #2a2a2a",color:"#1a1a1a",
